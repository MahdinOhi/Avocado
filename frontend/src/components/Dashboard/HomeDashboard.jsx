            ...
            <div className='flex-1 overflow-y-auto overflow-x-hidden'>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-12 gap-4 min-h-full'>
                ...
                <div className='lg:col-span-5 flex'>
                  <div
                    className='flex-1 bg-[#ECFAE5] rounded-2xl p-4 shadow-lg border border-[#DDF6D2] hover:shadow-xl transition-all duration-300 flex items-center justify-center min-h-[200px]'
                    style={{
                      boxShadow:
                        '0 8px 32px -8px rgba(176, 219, 156, 0.15), 0 0 0 1px rgba(255, 255, 255, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
                    }}
                ...
                <div className='lg:col-span-5 flex'>
                  <div
                    className='flex-1 bg-[#ECFAE5] rounded-2xl p-4 shadow-lg border border-[#DDF6D2] hover:shadow-xl transition-all duration-300 min-h-[300px]'
                    style={{
                      boxShadow:
                        '0 8px 32px -8px rgba(176, 219, 156, 0.15), 0 0 0 1px rgba(255, 255, 255, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
                    }}
                ...
                <div className='lg:col-span-7 flex'>
                  <div
                    className='flex-1 bg-[#ECFAE5] rounded-2xl p-4 shadow-lg border border-[#DDF6D2] hover:shadow-xl transition-all duration-300 flex flex-col min-h-[300px]'
                    style={{
                      boxShadow:
                        '0 8px 32px -8px rgba(176, 219, 156, 0.15), 0 0 0 1px rgba(255, 255, 255, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
                    }}
                  >
                    <h2 className='font-bold text-lg mb-3 text-gray-800 flex-shrink-0'>
                      My Tasks
                    </h2>
                ...
                <div className='lg:col-span-12 flex pb-4'>
                  <div
                    className='flex-1 bg-[#ECFAE5] rounded-2xl p-4 shadow-lg border border-[#DDF6D2] hover:shadow-xl transition-all duration-300'
                    style={{
                      boxShadow:
