  ...
  return (
    <Link
      ...
      className={`
        ...
        ${
          active
            ? 'bg-white/25 text-black shadow-lg font-semibold backdrop-blur-sm border border-white/30'
            : 'text-black/90 hover:bg-white/15 hover:text-white hover:shadow-md'
        }
      `}
      style={{
        boxShadow: active
